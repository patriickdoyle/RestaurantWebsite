...
public class DbConn {
    ...
    public DbConn() {
        ...
        String dbAndPass = "SP22_3308_tuh15728?user=tuh15728&password=aegeejov";
        ...
        try {
            ...
            try {
                ...
                recordError("Database unavailable - please try later or contact your administrator. "
                        + "Problem getting connection:" + e.getMessage());
            }
