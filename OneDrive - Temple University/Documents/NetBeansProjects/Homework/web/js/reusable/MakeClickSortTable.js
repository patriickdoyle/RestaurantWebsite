...
function MakeClickSortTable(title, objList, sortOrderPropName, sortIcon) {
    //boolean variables determine sorted state of table
    //var fwdSorted = false;
    ...
    function jsSort(objList, byProperty, sortClickCount) {
    ...
    function addSortedTableBody(table, list, sortOrderPropName, sortClickCount) {
        ...
        jsSort(list, sortOrderPropName, sortClickCount);
    ...
    for (var propName in obj) {
        ...
        if (propName[0] !== "_") {
            ...
            var sortClickCount = 0;
            headingCell.onclick = function () {
                console.log("WILL SORT ON " + this.sortPropName);
                addSortedTableBody(newTable, objList, this.sortPropName, sortClickCount);
                sortClickCount++;
            };
        }
    ...
    addSortedTableBody(newTable, objList, sortOrderPropName);

    searchInput.onkeyup = function () {
        console.log("search filter changed to " + searchInput.value);
        addFilterTableBody(newTable, objList, searchInput.value);
    };
