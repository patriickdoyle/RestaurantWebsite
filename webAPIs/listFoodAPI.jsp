...
<%@page language="java" import="model.food.StringData" %> 
<%@page language="java" import="model.food.StringDataList" %> 
<%@page language="java" import="view.FoodView" %> 
